...
![Color Change Image](http://felixtellmann.com/images/color-themes-with-react/color-change.gif)
    ...
    <>
      <style jsx global>{`
        ...
        body {
          padding: 0;
          margin: 0;
          font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Cantarell, Fira Sans, Helvetica Neue,
            sans-serif;
        }
...
By adding the script to the `body` before any other content is loaded, we avoid the **flash** successfully. You can find the code [here](https
