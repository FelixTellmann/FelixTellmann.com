...
- Storing Value
    ...
    - **Skill:** Once people learn how to use a product, they become better at using 
      it. Switching to another product is often associated with having to learn a 
      product form scratch. (think adobe photosphop)
