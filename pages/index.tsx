  ...
  const TIMELINE_CURRENT = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: (
            <>
              Finally after a few months of design & redesigns, and other projects in the background, I got my new page up and
              running.
            </>
          )
        },
        ...
        },
        {
          ...
          description: (
            <>
              From a successful restaurant to closing our doors in a matter of weeks. Its been a great journey, the uncertainty of
      ...
      items: [
        {
          ...
          description: (
            <>
              Used the restaurants sales & performance data to gather insights & to establish new training approaches for Smart-Up
              to use internally in the restaurant. Including a deep dive into MySQL & Oracle DB.
            </>
          )
        },
        {
          ...
          description: (
            <>
              Upgraded the concept to the fit market environment & changed the name from{' '}
              <u style={{ whiteSpace: 'nowrap' }}>The Burger Exchange</u> to <u style={{ whiteSpace: 'nowrap' }}>The Exchange</u>{' '}
              and shifted focus to also include a variety of woodfired grills. 🥩🔥{' '}
            </>
          )
        },
        {
      ...
      items: [
        {
          headline: (
            <>
              Opened <em>The Burger Exchange</em> 🍔
            </>
          ),
          description: (
            <>
              Its always been a dream, or said jokingly. Now we took the steps to Make it a Reality. A 200 seater Restaurant with
              our own Concept of a trendy upmarket Burger Joint.
            </>
          )
        },
        {
          ...
          description: (
            <>
              The first experience acquiring start-up funding.{' '}
              <em>You gotta move early and fast, as everyone else will slow you down.</em>{' '}
            </>
          )
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: (
            <>
              Found my first clients to work on the side and quickly grew to full time freelancing occupation, where I got hooked
              on React.js
            </>
          )
        },
        {
          ...
          description: (
            <>
              My Wife and I were both getting excited to start our own Food Truck and planned out many details. Unfortunately, the
      ...
      items: [
        {
          ...
          description: (
            <>
              I took some time to work on the marriage of my passions: Tech & Restaurants. Smart-up is a training platform & SaaS
              application for restaurant owners & managers to train their staff.
            </>
          )
        },
        {
          ...
          description: (
            <>
              This year was the year to pursue my interests in web development & tech professionally. I did a deep dive completing
              the FreeCodeCamp Front-end & Back-end Certifactions.
            </>
          )
        },
        {
          ...
          description: (
            <>
              After graduation, I got straight back to work. This time as General Manager, opening a brand new Restaurant in the
              CBD of Cape Town. I opened Raya Kitchen over 2 months including construction and building up a new team from
              scratch.
            </>
          )
        }
      ...
      items: [
        {
          ...
          description: (
            <>
              If this Year wasn't enough. I went back to University in 2015 to advance with a Postgraduate Diploma in Business
        ...
        },
        {
          ...
          description: (
            <>
              Liz and I decided to have a small ceremony with the closes friends & family at a beautiful wine farm in Cape Town.
            </>
          )
        },
        {
          ...
          description: (
            <>
              Started a Laptop Vinyl sticker business, while exploring the very interesting customer segment of students 👨‍ 🎓 It
              was part study, part real business, but somehow eventually faded & failed as we had a team of 6 co-founders.{' '}
              <em>Stick to 1 or 2 if you can. </em> 😉{' '}
            </>
          )
        },

        {
          ...
          description: (
            <>
              I left my full-time position early in 2015 to focus on my Postgraduate studies. Luckily, I was offered to continue
        ...
        },
        {
          ...
          description: (
            <>
              I asked my now fiancee, Elizabeth, to marry me. She said yes! I took her out for a super romantic dinner and popped
      ...
      items: [
        {
          headline: (
            <>
              First <em>Personal </em>&nbsp;Website
            </>
          ),
          description: (
            <>
              I got back to my old passion in Tech 👨 ‍💻💻 😄. While I build a couple of websites for other people & companies in
              the past, I decided to build my first own site with WordPress with a couple of blog posts. Unfortunately, I didn't
              use Git yet and lost the source code in an old HDD.
            </>
          )
        }
      ]
      ...
      items: [
        {
          ...
          description: (
            <>
              Joined the Best Asian Restaurant in South Africa as a Restaurant Manager overseeing a team of 50 employees. I
      ...
      items: [
        {
          ...
          description: (
            <>
              Started as a waiter and got promoted shortly after to Assistant Restaurant Manager at Salt Restaurant - at the
        ...
        },
        {
          ...
          description: (
            <>
              Completed my college after 3 years with three higher national diplomas graduating Summa Cum Laude, covering all
      ...
      items: [
        {
          ...
          description: (
            <>
              Spend 4 months traveling the seas onboard of the Yachts of Seabourn. Visited many countries in North America & The
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: (
            <>
              My first exciting endeavor in South Africa was a three months English course to find my feet. I went from hating
        ...
        },
        {
          ...
          description: (
            <>
              This was a big step for me at the age of 21. I decided to take on a different career path, jumping straight into my
      ...
      items: [
        {
          ...
          description: (
            <>
              I completed my last three years at a College for Technology and Media in Germany and shortly after found myself
      ...
      items: [
        {
          ...
          description: (
            <>
              Exploring the tech world as a teenager, bought a brand new Laser Mouse 🖱 at the Metreon downtown San Fransisco. By
              now I got into Gaming 🕹 & build my first websites using MS FrontPage 98.
            </>
          )
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: (
            <>
              My brother and I were lucky to be building our first computer from scratch, using my stepdads old hardware and
      ...
      items: [
        {
          ...
          description: (
            <>
              Travelling at 28.8Kbit Modem speeds 📠 🔌 💾 ..., t.t.t.t.t.t.t,tick
              eeeeeeeooohhhwwwwwaaa............Pshhhkkkkkkrrrr2ka, *ding*ding... %^&! Playing some Snowman browser game I will
              never forget.
            </>
          )
        }
