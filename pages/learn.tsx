...
import { InfoBlock, HeroText, Link } from 'components';
    ...
    <>
      ...
      <article>
        ...
        <p>
          ...
          just entertainment. Learning in Public is a shift from being the consumer to creating and documenting what we learn. An important note is
